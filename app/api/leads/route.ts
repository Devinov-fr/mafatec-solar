...
<tr><td align="center" style="padding:24px 12px;">
  ...
  <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;background-color:#ffffff;border-radius:14px;overflow:hidden;">
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td valign="middle" width="46" style="padding-right:14px;">
                <table role="presentation" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" valign="middle" width="46" height="46" style="width:46px;height:46px;background-color:#0b0e1d;border-radius:11px;color:#c9a96a;font-family:Georgia,serif;font-size:20px;">☀️</td></tr></table>
              </td>
              <td valign="middle">
    ...
    <!-- Bouton télécharger -->
    <tr><td style="padding:24px 40px 4px;" align="left">
    ...
    <!-- Séparateur -->
    <tr><td style="padding:30px 40px 0;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="border-top:1px solid #e7e4de;line-height:1px;font-size:1px;">&nbsp;</td></tr></table></td></tr>
